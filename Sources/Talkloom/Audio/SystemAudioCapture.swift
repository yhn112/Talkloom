...
final class SystemAudioProducer: SegmentProducer {
    enum Failure: Error, LocalizedError {
        ...
        var errorDescription: String? {
            ...
            case .tapCreationFailed(let detail):
                "Could not tap the system audio (\(detail)). Grant Talkloom access under System Settings › Privacy & Security › Audio Recording."
    ...
    private let ioQueue = DispatchQueue(
        label: "me.diskin.Talkloom.system-audio", qos: .userInitiated)
    ...
    private func createTap() throws -> Generation {
        ...
        description.name = "Talkloom system audio"
    ...
    private func createAggregate(around tapUID: String) throws -> AudioHardwareAggregateDevice {
        ...
        let description: [String: Any] = [
            kAudioAggregateDeviceNameKey: "Talkloom System Audio",
