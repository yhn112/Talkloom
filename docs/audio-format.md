...
constraint costs nothing. `Packages/TranscriberCore/Sources/TranscriberCore/SessionAudio.swift`
...
measured at 2.709 s on a real recording (`Tests/TranscriberTests/StartupLatencyTests.swift`).
